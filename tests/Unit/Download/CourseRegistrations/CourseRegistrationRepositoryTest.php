...
it('can save a valid course registrations for a student', function (): void {
    $registrationNumber = FakeCourseRegistrationClientClient::COURSE_REGISTRATIONS[0]['registration_number'];
    ...
    $expectedRecords = groupArrays(
        FakeCourseRegistrationClientClient::COURSE_REGISTRATIONS,
