<html lang="en">
<head>
  <title>{{ "$student->registrationNumber - FINAL RESULTS - EBSU RESULT DATABASE OFFICE - " . auth()->id() }}</title>
    ...
    <div class="flex flex-row items-baseline">
      ...
      <div class="basis-2/3">
        <div class="flex flex-col text-center">
          ...
          <span class="text-black  text-sm font-bold">STUDENT'S FINAL RESULT (DRAFT COPY)</span>
        </div>
      </div>
      {{-- Passport --}}
      <div class="basis-1/6 text-center text-gray-300"></div>
