...
const form = useForm({
  registration_number: props.student.baic.registrationNumber,
  remark: "",
  has_mail: false,
  mail_title: "",
  mail_date: "",
...
const title = `Update Student's Registration Number (${props.student.baic.registrationNumber})`;

const canNotUpdate = computed(
  () => props.student.baic.registrationNumber === form.registration_number || form.processing,
);
...
const submit = () =>
  form.patch(route("student.registrationNumber.update", { student: props.student.baic.slug }), {
