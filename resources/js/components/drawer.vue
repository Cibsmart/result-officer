                  ...
                  <div class="px-4 sm:px-6">
                    <div class="flex items-start justify-between space-x-3">
                      ...
                      <div class="ml-3 flex h-7 items-center">
                        <button
                          class="relative rounded-md text-gray-700 hover:text-gray-900 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-hidden dark:text-gray-100 dark:hover:text-white"
                          type="button"
                          @click="close">
